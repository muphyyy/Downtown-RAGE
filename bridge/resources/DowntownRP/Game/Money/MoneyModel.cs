...
namespace DowntownRP.Game.Money
{
    ...
    {
        public async static Task<bool> AddMoney(Client player, double money_to_add)
        {
        ...
        public async static Task<bool> SubMoney(Client player, double money_to_sub)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return false;
            Data.Entities.User user = player.GetData("USER_CLASS");
        ...
        public static bool HasEnoughMoney(Client player, double amount)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return false;
            Data.Entities.User user = player.GetData("USER_CLASS");
