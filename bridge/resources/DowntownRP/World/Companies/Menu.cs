...
namespace DowntownRP.World.Companies
{
    public class Menu : Script
    {
        ...
        public void RE_MenuCompanyClose(Client player)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData("USER_CLASS");
        ...
        public async Task RE_MenuCompanyChangeName(Client player, string name)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData("USER_CLASS");
        ...
        public void RE_MenuCompanyOfficeStatus(Client player, int status)
        {
            // var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData("USER_CLASS");
        ...
        public void RE_MenuCompanyRecruitmentMode(Client player, int status)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData("USER_CLASS");
        ...
        public async Task RE_MenuCompanyGanancias(Client player, string cant)
        {
        ...
        public async Task RE_MenuCompanySubsidio(Client player, string cant)
        {
            int cantidad = Convert.ToInt32(cant);
        ...
        public async Task RE_MenuCompanyIngresar(Client player, string cant)
        {
            int cantidad = Convert.ToInt32(cant);
