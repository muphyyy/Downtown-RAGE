...
namespace DowntownRP.World.Banks
{
    public class Main : Script
    {
        ...
        public void Banks_EnterColShape(ColShape shape, Player player)
        {
            //var banco = shape.GetExternalData<Data.Entities.Bank>(0);
            if (!shape.HasData("BANK_CLASS")) return;
            Data.Entities.Bank banco = shape.GetData<Data.Entities.Bank>("BANK_CLASS");
        ...
        public void RE_ActionBank(Player player)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public void RE_ActionBankClose(Player player)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public async Task RE_BankAccountCreate(Player player, string pin, string repin)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public static async Task BankAccountCreateSecure(Player player, string pin)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public void RE_BankAccountLogin(Player player, string pin)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public async Task RE_BankDepositMoney(Player player, string money)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public async Task RE_BankRetirarMoney(Player player, string money)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public async Task RE_BankTransferirMoney(Player player, string iban, string money)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
