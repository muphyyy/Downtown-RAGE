...
namespace DowntownRP.World.Business
{
    public class Main : Script
    {
        ...
        public void Business_EnterColShape(ColShape shape, Player player)
        {
            //var business = shape.GetExternalData<Data.Entities.Business>(0);
            if (!shape.HasData("BUSINESS_CLASS")) return;
            Data.Entities.Business business = shape.GetData<Data.Entities.Business>("BUSINESS_CLASS");
        ...
        public void Business_ExitColShape(ColShape shape, Player player)
        {
            //var business = shape.GetExternalData<Data.Entities.Business>(0);
            if (!shape.HasData("BUSINESS_CLASS")) return;
            Data.Entities.Business business = shape.GetData<Data.Entities.Business>("BUSINESS_CLASS");
        ...
        public async Task RE_BusinessFinishCreation(Player player, string name)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
            ...
            if (user.adminLv == 5)
            {
                if (player.HasData("CreateBusinessType"))
                {
                    if (player.HasData("CreateBusinessPrice"))
                    {
                        ...
                        int type = player.GetData<int>("CreateBusinessType");
                        int price = player.GetData<int>("CreateBusinessPrice");
        ...
        public void RE_ActionOpenBuyBusiness(Player player)
        {
            if (!player.HasData("USER_CLASS")) return;
        ...
        public void RE_CloseBrowserBuyBusiness(Player player)
        {
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
        ...
        public async Task RE_BuyBusiness(Player player)
        {
            //var user = player.GetExternalData<Data.Entities.User>(0);
            if (!player.HasData("USER_CLASS")) return;
            Data.Entities.User user = player.GetData<Data.Entities.User>("USER_CLASS");
